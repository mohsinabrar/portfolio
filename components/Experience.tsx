...
const experiences = [
  {
    ...
    location: 'Remote',
    description: 'Developed and maintained backend services using Node.js and Express. Worked on API integrations and database optimization.',
    highlights: [
  ...
  },
  {
    ...
    company: 'MIT Trainers',
    duration: 'Jun 2023 - Aug 2023',
    location: 'Remote',
    description: 'Worked on machine learning projects involving data preprocessing, model training, and evaluation. Gained hands-on experience with TensorFlow and Keras.',
    highlights: [
      'Developed CNN models for image classification',
      'Performed data preprocessing and augmentation',
      'Achieved 85% accuracy on CIFAR-10 dataset',
    ],
