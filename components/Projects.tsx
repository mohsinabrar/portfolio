...
const fallbackProjects: Project[] = [
  {
    ...
    description: 'Developed a responsive e-commerce platform with product listing, cart, and multi-step checkout. Improved UX with clean UI and structured navigation.',
  ...
  },
  {
    ...
    description: 'Designed a booking interface with room listing and availability display. Reduced simulated booking steps by 30% through better layout and navigation.',
  ...
  },
  {
    ...
    description: 'Built a CNN deep learning model for 10-class image classification on 60,000 images. Applied preprocessing, batch normalization, and dropout achieving 75%+ validation accuracy.',
  ...
  },
  {
    ...
    description: 'Trained a regression model with feature engineering and cross-validation; R-squared score: 0.82. Performed data cleaning and feature selection on real housing data.',
  ...
  {
    id: 5,
    name: 'Medicine Information Website',
    description: 'Built a structured portal for managing and browsing medicine-related data with clean UI. Focused on intuitive navigation and organized data display.',
  ...
  },
  {
    id: 6,
    name: 'Bridal Website',
    description: 'Shipped a fully responsive bridal showcase frontend in under 48 hours using AI vibe coding tools. Demonstrated 3x faster delivery vs traditional workflow using Cursor AI and Lovable.',
    html_url: 'https://github.com/mohsinabrar/bridal-website',
    homepage: 'https://wedding-demo.vercel.app',
    topics: ['cursor-ai', 'lovable', 'html', 'css'],
    language: 'HTML/CSS',
  },
]
